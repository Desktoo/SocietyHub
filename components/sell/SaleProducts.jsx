  ...
  return (
    ...
    >
        <div className='relative w-full h-56'>
            <Image src={product.imageUrl && product.imageUrl.trim() ? product.imageUrl : placeholderImg} alt='productImg' fill className='object-cover' />
        </div>
        <div className='p-5 bg-white w-full rounded-b-lg flex flex-col '>
            <div className='flex w-full justify-between'>
                <label className="text-left font-bold text-xl md:text-xl text-gray-800">{product.productName}</label>
