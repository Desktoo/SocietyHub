...
const visuals = {
  ...
  bubbles: [
    { top: "10rem", left: "2.5rem", size: "w-20 h-20", color: "bg-teal-500/20" },
    { top: "2.5rem", left: "2.5rem", size: "w-20 h-20", color: "bg-teal-500/20" },
    { top: "20rem", right: "5rem", size: "w-32 h-32", color: "bg-emerald-500/20" },
    { top: "40rem", left: "2.5rem", size: "w-20 h-20", color: "bg-emerald-500/20" },
    { top: "7.5rem", right: "20rem", size: "w-40 h-40", color: "bg-emerald-500/20" }
  ],
      ...
      <section className='flex-1 flex flex-col justify-center'>
        <div className='text-center mx-5 mt-16 md:mt-20'>
          <motion.div
            ...
            {...visuals.fadeInUp}
          > 
            <span className='text-2xl md:text-4xl font-bold mb-2'>Welcome to</span> 
            <span className="text-5xl md:text-8xl lg:text-9xl font-black leading-tight">SocietyHub</span>
          </motion.div>
          ...
          > 
            Discover amazing products at unbeatable prices. Your one-stop for everything you need  
          </motion.p>
          ...
          {visuals.statsData.map((item) => (
            ...
            >
              <div className='w-20 h-20 bg-neutral-200 flex items-center justify-center rounded-lg mb-3 mx-auto'>
                {React.cloneElement(item.icon, { className: 'w-8 h-8 text-neutral-800' })}
              </div>
      ...
      <section className='py-20 px-4'>
        <div className='max-w-4xl mx-auto grid md:grid-cols-2 gap-8'>
          {/* Seller Card */}
            ...
            >
              <div className='p-6 mb-4'>
                <Image src={seller} className='w-24 h-24 object-contain' alt='seller' />
              </div>
              <p className='text-2xl font-semibold text-center mb-4'>Sell your Products</p>
              ...
              >
                <p className='text-neutral-600 text-sm leading-relaxed'>
                  List your products and start earning by reaching buyers across the platform.
                </p>
              </motion.div>
            </motion.div>
          ...
          <Link href='/products'>
            ...
            >
              <div className='p-6 mb-4'>
                <Image src={buyer} className='w-24 h-24 object-contain' alt='buyer' />
              </div>
              <p className='text-2xl font-semibold text-center mb-4'>Join as Buyer</p>
              ...
              >
                <p className='text-emerald-700 text-sm leading-relaxed'>
                  Discover and purchase products from a wide range of trusted sellers.
                </p>
              </motion.div>
            </motion.div>
          </Link>
